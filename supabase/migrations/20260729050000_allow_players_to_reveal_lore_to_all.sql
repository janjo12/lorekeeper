drop function if exists public.reveal_entity_content_to_players(uuid, uuid, text, uuid[]);

create or replace function public.reveal_entity_content_to_players(
  requesting_user_id uuid,
  requested_content_id uuid,
  content_type text,
  reveal_to_all boolean,
...
revoke execute on function public.reveal_entity_content_to_players(
  uuid,
  uuid,
  text,
  boolean,
...
grant execute on function public.reveal_entity_content_to_players(
  uuid,
  uuid,
  text,
  boolean,
