  ...
  return (
    <form action={action} className="profile-form">
      <div className="field">
        ...
        <input id="profile-username" name="username" defaultValue={username} required minLength={3} maxLength={32} />
      ...
      <button className="primary-button" disabled={pending} type="submit">{pending ? "Saving…" : "Save username"}</button>
    </form>
  );
}
